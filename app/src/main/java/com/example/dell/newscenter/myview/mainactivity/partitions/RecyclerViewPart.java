...
public class RecyclerViewPart extends RecyclerView {
    ...
    public RecyclerViewPart(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        layoutManager.setGapStrategy(StaggeredGridLayoutManager.GAP_HANDLING_MOVE_ITEMS_BETWEEN_SPANS);
        ...
        RecyclerViewPart.MyAdapter myAdapter = new RecyclerViewPart.MyAdapter(partList);
    ...
    class MyAdapter extends RecyclerView.Adapter<RecyclerViewPart.MyAdapter.ViewHolder> {
...
//            view.setLayoutParams(new LayoutParams(size,size));
        ...
        @Override
        public void onBindViewHolder(@NonNull RecyclerViewPart.MyAdapter.ViewHolder holder, final int position) {
