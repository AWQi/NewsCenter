...
public class DownloadProjectRecyclerViewLayout extends LinearLayout{
        ...
        public DownloadProjectRecyclerViewLayout(Context context, @Nullable AttributeSet attrs) {
            super(context, attrs);
            this.context = context;
            LayoutInflater.from(context).inflate(R.layout.activity_download,this);
            onCreate(null);
        }
